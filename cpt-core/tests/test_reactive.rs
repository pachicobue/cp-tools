...
#[test]
fn test_reactive_directory_not_found() {
...
#[test]
fn test_reactive_basic_success() {
    with_tempdir(|tempdir| {
...
#[test]
fn test_reactive_with_timelimit() {
    with_tempdir(|tempdir| {
        prepare_testcase(tempdir.path(), "AC_1", "hello", "hello");
...
#[test]
fn test_reactive_command_exec_failed() {
    with_tempdir(|tempdir| {
        prepare_testcase(tempdir.path(), "AC_1", "hello", "hello");
...
#[test]
fn test_reactive_input_only_case() {
    with_tempdir(|tempdir| {
